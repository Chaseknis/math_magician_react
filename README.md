...
***In this activity you will set up a React project for the Math Magician SPA and setup linters***
...
Feel free to check the [issues page](https://github.com/Chaseknis/leaderboard/issues).
